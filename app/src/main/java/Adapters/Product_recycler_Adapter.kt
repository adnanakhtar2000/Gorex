...
class Product_recycler_Adapter (val product_image : List<Int> , val product_name : List<String> , val product_price : List<String> ) : RecyclerView.Adapter<product_recycler_viewholder>() {
