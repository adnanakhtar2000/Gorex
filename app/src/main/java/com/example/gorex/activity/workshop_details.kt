...
import com.example.gorex.Adapters.Workshop_services_Adapter
...
class workshop_details : AppCompatActivity() , cellclicklistner {
    ...
    var services_logo : List<Int> = listOf(
        R.drawable.ic_noun_car_battery_2082376,
        R.drawable.ic_noun_engine_oil_1979324,
        R.drawable.ic_noun_car_transmission_1563498,
        R.drawable.ic_noun_fuel_780293,
        R.drawable.ic_noun_car_oil_filter_3189909
    )
